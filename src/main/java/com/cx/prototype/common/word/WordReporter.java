package com.cx.prototype.common.word;
...
public class WordReporter {
     ...
     * @throws Exception
     */
    private void fillBlock(XWPFParagraph para, Map<String, Object> params, Map<Integer, String> tempMap, int index) throws Exception {
        Matcher matcher;
    ...
    private void setCellText(XWPFTableCell tmpCell, XWPFTableCell cell, String text) throws Exception {
        ...
        // 复制字体信息
        if (tmpR != null) {
            tmpR.setBold(tmpR.isBold());
//            tmpR.setBold(true); //字体加粗
            tmpR.setFontSize(10); //字体大小
    ...
    public static void main(String[] args) throws Exception {
        ...
        //设置模板文件路径
        WordReporter exporter = new WordReporter("F:\\edu-project\\admin\\target\\Rencai\\exportTem\\temp.docx");
        ...
        params.put("name", "张一张");
        params.put("sex", "男");
        params.put("nation", "aaaa");
        params.put("idcard", "aaaa");
        params.put("qq", "aaaa");
        params.put("addr", "aaaa");
        params.put("birthDay", "aaaa");
        params.put("political", "aaaa");
        params.put("education", "aaaa");
        params.put("email", "aaaa");
        params.put("category", "aaaa");

        Map<String, String> picMap = new HashMap<String, String>();
        picMap.put("width", "130");
        picMap.put("height", "120");
        picMap.put("type", "jpg");
        picMap.put("path", "http://192.168.10.102:8121/upload/png/2b176b31-f198-484b-8723-2f89bf670da0.png");
        params.put("logo", picMap);
        //导出到word (这个的0 代表的是模板中的第一个表格,也就是表格的index位置)
        exporter.export(params, 0);

        //生成多个记录
        List<Map<String, String>> list = new ArrayList<Map<String, String>>();
        Map<String, String> m1 = new HashMap<String, String>();
        m1.put("beginTimeStr", "李四1");
        m1.put("endTimeStr", "20");
        m1.put("company", "男");
        m1.put("position", "攻城狮1");
        list.add(m1);
        Map<String, String> m2 = new HashMap<String, String>();
        m2.put("beginTimeStr", "李四2");
        m2.put("endTimeStr", "22");
        m2.put("company", "女");
        m2.put("position", "攻城狮2");
        list.add(m2);
        Map<String, String> m3 = new HashMap<String, String>();
        m3.put("beginTimeStr", "李四3");
        m3.put("endTimeStr", "23");
        m3.put("company", "男3");
        m3.put("position", "攻城狮3");
        list.add(m3);
        exporter.export(list, 1);
